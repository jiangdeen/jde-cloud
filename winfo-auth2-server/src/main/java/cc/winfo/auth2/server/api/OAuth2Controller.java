...
import cc.winfo.common.core.api.enums.DateFormatEnum;
    ...
    public   Map<String, Object>  getToken(@RequestParam String username, @RequestParam String password) {
        ...
        try {
            ...
            for (GrantedAuthority authority : authorities) {
                list.add(JSONObject.parseObject(authority.getAuthority(), Map.class));
            }
            ...
            e.printStackTrace();
            throw  new BaseException("登录异常，请检查登录信息...");
        }
    }
